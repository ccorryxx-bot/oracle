      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between gap-4">
        ...
        <nav class="hidden md:flex items-center gap-6">
          <NuxtLink to="/" class="text-sm transition-colors"
            style="color:#94A3B8" active-class="!text-white">Listings</NuxtLink>
          <NuxtLink to="/sell" class="text-sm transition-colors"
            style="color:#94A3B8" active-class="!text-white">Sell</NuxtLink>
        </nav>
        ...
        <div class="flex items-center gap-3">
          <template v-if="user">
            <NuxtLink to="/dashboard"
              ...
              style="color:#94A3B8">Dashboard</NuxtLink>
            <!-- Notification dot -->
            <button class="relative p-2 rounded-lg transition"
              style="color:#64748B" @click="() => {}">
          ...
          <template v-else>
            <NuxtLink to="/auth/login"
              ...
              style="background:#7C3AED" onmouseover="this.style.background='#6D28D9'"
    ...
    <footer class="border-t py-8" style="border-color:rgba(255,255,255,0.06)">
      <div class="max-w-7xl mx-auto px-4 flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <div class="flex items-center gap-4">
          <a href="#" class="text-xs transition-colors" style="color:#475569">Terms</a>
          <a href="#" class="text-xs transition-colors" style="color:#475569">Privacy</a>
          <a href="#" class="text-xs transition-colors" style="color:#475569">Contact</a>
        </div>
      </div>
    </footer>
